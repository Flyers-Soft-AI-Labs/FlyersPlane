...
const integrationDetails: { [key: string]: any } = {
  github: {
    ...
    notInstalled: "Connect GitHub with your Flyers Soft workspace to sync project work items.",
  },
  slack: {
    logo: SlackLogo,
    installed: "Activate Slack on individual projects to sync with specific channels.",
    notInstalled: "Connect Slack with your Flyers Soft workspace to sync project work items.",
  },
};
