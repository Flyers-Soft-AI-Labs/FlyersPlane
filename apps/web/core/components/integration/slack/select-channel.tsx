  ...
  return (
    <>
      {projectIntegration ? (
        <button
          type="button"
          className={`bg-accent-primary relative inline-flex h-4 w-6 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none`}
          role="switch"
          aria-checked
          onClick={() => {
        ...
        >
          <span
            aria-hidden="true"
            className={`shadow inline-block h-2 w-2 transform self-center rounded-full bg-surface-1 ring-0 transition duration-200 ease-in-out ${
