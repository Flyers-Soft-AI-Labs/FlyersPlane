...
export const FiltersRow = observer(function FiltersRow<K extends TFilterProperty, E extends TExternalFilter>(
  ...
  const mainContent = (
    <div className="flyers-soft-filters-row flex w-full items-start gap-2 rounded-lg bg-layer-1 px-4 py-2">
  ...
  const HeaderVariant = (
    <Header variant={EHeaderVariant.TERNARY} className="flyers-soft-filters-shell min-h-11 bg-surface-1 !px-3">
      {mainContent}
    </Header>
  );
